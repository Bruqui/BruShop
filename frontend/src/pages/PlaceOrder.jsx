                ...
                <form className='max-padd-container py-10'>
                    <div className='flex flex-col xl:flex-row gap-20 xl:gap-28'>
                        ...
                        <div className='flex-1 flex flex-col gap-3 text-[95%]'>
                            <Titles title1={"Delivery"} title2={"Information"} />
                            ...
                            <input type="text" placeholder='Email Address' className='ring-1 ring-slate-900/15 p-1 pl-3 rounded-sm bg-white outline-none' />
                            <input type="text" placeholder='Phone Number' className='ring-1 ring-slate-900/15 p-1 pl-3 rounded-sm bg-white outline-none' />
                            ...
                            <div className='flex gap-3'>
                                <input type="text" placeholder='Zip Code' className='ring-1 ring-slate-900/15 p-1 pl-3 rounded-sm bg-white outline-none w-1/2' />
