          ...
          <form className='flex flex-col items-center w-[90%] sm:max-w-md m-auto gap-y-5'>
            ...
            {currState === "Sign Up" && (
              <div className='w-full'>
                ...
                <input type="text" placeholder='Name' className='w-full px-3 py-1.5 ring-1 ring-slate-900/5 rounded bg-primary mt-1' />
              </div>
            )}
            <div className='w-full'>
              <label htmlFor="email" className='medium-15'>Email</label>
              <input type="text" placeholder='Email' className='w-full px-3 py-1.5 ring-1 ring-slate-900/5 rounded bg-primary mt-1' />
            </div>
            <div className='w-full'>
              <label htmlFor="password" className='medium-15'>Password</label>
              <input type="text" placeholder='Password' className='w-full px-3 py-1.5 ring-1 ring-slate-900/5 rounded bg-primary mt-1' />
            </div>
