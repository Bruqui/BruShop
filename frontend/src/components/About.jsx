    ...
    <section className='max-padd-container py-16'>
      ...
      <div className='flex flex-col md:flex-row gap-5 gap-y-10'>
        ...
        <div className='flex-1 flexCenter flex-col'>
          <Titles title1={'Poeple'} title2={'Says'} title1Styles={'h3'} titleStyles={'!pb-2'} />
          <img src={testimonial} alt="" height={55} width={55} className='rounded-full' />
          <h4 className='h4 mt-6'>
            John Doe
          </h4>
          ...
          <p className='max-w-[222px] mt-5 text-center'>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Architecto neque dolor nostrum repellat enim nemo dolorem odit quasi dolore consectetur debitis maiores omnis quisquam, nam vel laudantium earum soluta reprehenderit?
          </p>
        </div>
        {/** BANNER */}
        ...
        {/** About */}
        <div className='flex-[1] flexCenter flex-col'>
          <Titles title1={'About'} title2={'Us'} title1Styles={'h3'} titleStyles={'!pb-2'} />
