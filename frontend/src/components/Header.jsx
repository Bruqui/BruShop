        ...
        <header className='max-padd-container w-full mb-2'>
            <div className='flexBetween py-3'>
                ...
                <div className='flex-1 flex items-center justify-end gap-x-2 xs:gap-x-8'>
                    {/* MENU TOGGLE */}
                    <>
                        {menuOpened ? (<FaBarsStaggered onClick={toggleMenu} className='xl:hidden cursor-pointer text-xl' />) : (<FaBars onClick={toggleMenu} className='xl:hidden cursor-pointer text-xl' />)}
                    </>
                    {/* CART */}
